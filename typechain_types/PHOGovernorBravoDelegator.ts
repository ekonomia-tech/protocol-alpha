...
export interface PHOGovernorBravoDelegatorInterface extends utils.Interface {
  functions: {
...
export interface PHOGovernorBravoDelegator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PHOGovernorBravoDelegatorInterface;

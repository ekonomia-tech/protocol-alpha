...
export interface DummyOracleInterface extends utils.Interface {
  functions: {
    ...
    "WSTETH_ADDRESS()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "WSTETH_ADDRESS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DummyOracle extends BaseContract {
  ...
  functions: {
    ...
    WSTETH_ADDRESS(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    WSTETH_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    WSTETH_ADDRESS(overrides?: CallOverrides): Promise<PopulatedTransaction>;

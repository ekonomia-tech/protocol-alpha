...
export interface TONGovernorBravoDelegatorInterface extends utils.Interface {
  functions: {
...
export interface TONGovernorBravoDelegator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TONGovernorBravoDelegatorInterface;

...
export interface PHOGovernorBravoDelegateInterface extends utils.Interface {
  functions: {
...
export interface PHOGovernorBravoDelegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PHOGovernorBravoDelegateInterface;

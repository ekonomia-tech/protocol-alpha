...
library PoolLibrary {
        ...
        returns (uint256, uint256)
    {
        ...
        // Scoping for stack concerns
        {
            ...
            share_dollar_value_d18 =
                params.share_amount.mul(params.share_price_usd).div(1e6);
            c_dollar_value_d18 =
                params.collateral_amount.mul(params.col_price_usd).div(1e6);
        }
    ...
    // Must be internal because of the struct
    function calcBuyBackShare(BuybackShare_Params memory params)
        internal
        pure
        returns (uint256)
    {
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 effective_collateral_ratio =
            global_collat_value.mul(1e6).div(eusd_total_supply); //returns it in 1e6

...
import {BondBaseSDA} from "@modules/bondsModule/bases/BondBaseSDA.sol";
import {IBondAggregator} from "@bondprotocol/bases/BondBaseSDA.sol";
...
contract BondFixedTermSDA is BondBaseSDA {
    ...
    constructor(address tonTimelock_, IBondTeller teller_, IBondAggregator aggregator_)
        BondBaseSDA(tonTimelock_, teller_, aggregator_)
    {}

...
import {IBondCallback} from "@modules/bondsModule/interfaces/IBondCallback.sol";
...
abstract contract BondBaseCallback is IBondCallback, Ownable, ReentrancyGuard {
    ...
    /// @inheritdoc IBondCallback
    function callback(uint256 id_, uint256 inputAmount_, uint256 outputAmount_)
        external
        override
        nonReentrant
    {
    ...
    function withdraw(address to_, ERC20 token_, uint256 amount_) external onlyOwner {

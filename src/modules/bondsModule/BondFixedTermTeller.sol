...
import {BondBaseTeller} from "@modules/bondsModule/bases/BondBaseTeller.sol";
import {IBondAggregator} from "@bondprotocol/bases/BondBaseTeller.sol";
import {IBondFixedTermTeller} from "@bondprotocol/interfaces/IBondFixedTermTeller.sol";

import {TransferHelper} from "@bondprotocol/lib/TransferHelper.sol";
import {FullMath} from "@bondprotocol/lib/FullMath.sol";
import {ERC1155} from "@bondprotocol/lib/ERC1155.sol";
...
contract BondFixedTermTeller is BondBaseTeller, IBondFixedTermTeller, ERC1155 {
    ...
    constructor(address tonTimelock_, address protocol_, IBondAggregator aggregator_)
        BondBaseTeller(tonTimelock_, protocol_, aggregator_)
    {}
    ...
    function _handlePayout(address recipient_, uint256 payout_, ERC20 payoutToken_, uint48 vesting_)
        internal
        override
    ...
    function _deploy(uint256 tokenId_, ERC20 underlying_, uint48 expiry_) internal {
        ...
        tokenMetadata[tokenId_] =
            TokenMetadata(true, underlying_, uint8(underlying_.decimals()), expiry, 0);
    ...
    function getTokenId(ERC20 underlying_, uint48 expiry_) public pure override returns (uint256) {
        ...
        uint256 tokenId =
            uint256(keccak256(abi.encodePacked(underlying_, expiry_ / uint48(1 days))));
        return tokenId;
    }

...
contract ModuleManagerTest is BaseSetup {
    ...
    function testBurnDeprecatedModule() public {
        _moduleMintPHO(user1, ONE_HUNDRED_THOUSAND_D18);
    ...
    /// @notice helper function to mint  PHO to a user
    function _moduleMintPHO(address to, uint256 amount) internal {
        vm.prank(module1);
        moduleManager.mintPHO(to, amount);
    }
}

...
//         priceController =
//         new PriceController(address(pho), address(moduleManager), address(priceOracle), address(fraxBPPhoMetapool), USDC_ADDRESS, address(curveFactory), owner, 3600, 10 ** 4, 50000,99000);
